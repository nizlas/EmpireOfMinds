...
- `make_prototype_play_map()` — larger axial disk (**R** = **7**, **169** cells) with hand-authored **PLAINS** / **GRASSLAND** / **WATER** and **HILLS** landform sectors for pan/zoom and art review; **`(0,0)`** remains **PLAINS** + **FLAT**.
