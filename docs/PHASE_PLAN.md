...
**Status:** approved direction; **N0 documentation complete (2026-08)**; runtime implementation **in progress** — N1, N3a and N3b are done (N3b **visually approved 2026-08**), and the native cg_plain solver backend (N3b.1a/N3b.1b) is in place; rendering/mesh/collision slices (N3c+) not started. This milestone is decoupled from the Phase 5.x gameplay numbering: it is presentation/terrain work and does not change gameplay rules until the new match core lands (N5+).
