...
7. **N8R architectural review PASS (2026-08-08 at `709810c`); N8c shipped** on that core (authoritative tick + deterministic delivery) and must keep calling the canonical tick/delivery module — never copy it.
