...
- **No interim fake terrain:** no stepped-hex renderer from separate flat plates. N1 ends with a tested non-rendered foundation. First visible terrain is the real continuous TS-08 dataset surface (N3 after N2 export). TS-08 solver not redesigned.
