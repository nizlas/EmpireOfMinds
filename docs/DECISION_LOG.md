...
- **Caveat:** N7d remains **manual/visual gate pending** (the gate now = the one-PC debug session; checklist section added to [VALIDATION_CHECKLIST.md](VALIDATION_CHECKLIST.md)). Docs reconciled: [PHASE_PLAN.md](PHASE_PLAN.md), [CLOUD_PLAY.md](CLOUD_PLAY.md), [TESTING.md](TESTING.md).
