...
| **Overlays / landmark** | [CityWorkedTilesView](../game/presentation/city_worked_tiles_view.gd) (**planning-only** worked markers), [TileYieldOverlayView](../game/presentation/tile_yield_overlay_view.gd), [LightningTreeView](../game/presentation/lightning_tree_view.gd), nameplate views |
