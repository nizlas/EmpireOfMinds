...
def _tiny_match_with_capital(client: TestClient) -> dict:
...
def test_accepted_warrior_project(client: TestClient) -> None:
    m = _tiny_match_with_capital(client)
    mid = m["match_id"]
    ...
    body = _scp(client, mid, action_headers, project_id="produce_unit:warrior")
...
def test_accepted_settler_project(client: TestClient) -> None:
    ...
    mid = m["match_id"]
    action_headers = m["headers"]
    body = _scp(client, mid, action_headers, project_id="produce_unit:settler")
    assert body["accepted"] is True
...
def test_set_city_production_event(client: TestClient) -> None:
    ...
    mid = m["match_id"]
    action_headers = m["headers"]
    _scp(client, mid, action_headers, project_id="produce_unit:warrior")
...
def test_not_current_player(client: TestClient) -> None:
    ...
    mid = m["match_id"]
    action_headers = m["headers"]
    r = _scp(client, mid, action_headers, actor_id=1)
...
def test_city_not_owned(client: TestClient) -> None:
    ...
    r = _scp(client, mid, action_headers, actor_id=1, project_id="produce_unit:warrior")
...
def test_unknown_city(client: TestClient) -> None:
    ...
    mid = m["match_id"]
    action_headers = m["headers"]
    r = _scp(client, mid, action_headers, city_id=99)
...
def test_unknown_city_project(client: TestClient) -> None:
    ...
    mid = m["match_id"]
    action_headers = m["headers"]
    r = _scp(client, mid, action_headers, project_id="produce_unit:invalid")
...
def test_city_project_not_unlocked(client: TestClient) -> None:
    ...
    r = _scp(client, mid, action_headers, project_id="produce_unit:settler")
...
def test_project_already_set_rejected(client: TestClient) -> None:
    ...
    action_headers = m["headers"]
    _scp(client, mid, action_headers, project_id="produce_unit:warrior")
    r = _scp(client, mid, action_headers, project_id="produce_unit:warrior")
    assert r["accepted"] is False
...
def test_clear_production_none(client: TestClient) -> None:
    ...
    action_headers = m["headers"]
    _scp(client, mid, action_headers, project_id="produce_unit:warrior")
    r = _scp(client, mid, action_headers, project_id="none")
    assert r["accepted"] is True
...
def test_unsupported_schema_version_rejects(client: TestClient) -> None:
    ...
    mid = m["match_id"]
    action_headers = m["headers"]
    r = _scp(client, mid, action_headers, schema_version=1)
...
def test_snapshot_v2_progress_preserved_after(client: TestClient) -> None:
    ...
    _scp(client, mid, action_headers)
