# Empire of Minds — TS-04 one-shot FemThinPlate blend regeneration helper.
# Run: blender --background --python tools/blender/terrain/run_ts_fem_thin_plate_blend_regen.py
...
def _resolve_terrain_tools_dir() -> Path:
    ...
    try:
        ...
        for text in bpy.data.texts:
            if text.filepath and Path(text.filepath).name == "run_ts_fem_thin_plate_blend_regen.py":
...
module.PROTOTYPE_ID = "TS-04"
module.RUNNER_FILE = __file__
module.USE_FEM_THIN_PLATE_SURFACE = True
print("[TS-04] USE_FEM_THIN_PLATE_SURFACE=True (FEM thin-plate regeneration)")
module.main()
