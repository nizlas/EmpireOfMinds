# Empire of Minds — TS-08 Stage 3a basic cliff-wall regeneration runner.
# Run: blender --background --python tools/blender/terrain/run_ts08_stage3a_basic_cliff_walls_regen.py
...
_RUNNER_NAME = "run_ts08_stage3a_basic_cliff_walls_regen.py"
_GENERATOR = "generate_ts08_stage3a_basic_cliff_walls.py"
...
spec = importlib.util.spec_from_file_location("eom_ts08_stage3a", GENERATOR)
...
print(f"[{module.PROTOTYPE_ID}] dedicated TS-08 Stage 3a basic cliff-wall regeneration")
module.main()
