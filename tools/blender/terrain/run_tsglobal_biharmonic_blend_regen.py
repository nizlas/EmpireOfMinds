# Empire of Minds — TS-02 one-shot GlobalBiharmonic blend regeneration helper.
# Run: blender --background --python tools/blender/terrain/run_tsglobal_biharmonic_blend_regen.py
...
def _resolve_terrain_tools_dir() -> Path:
    ...
    try:
        ...
        for text in bpy.data.texts:
            if text.filepath and Path(text.filepath).name == "run_tsglobal_biharmonic_blend_regen.py":
...
module.PROTOTYPE_ID = "TS-02"
module.RUNNER_FILE = __file__
module.USE_GLOBAL_BIHARMONIC_SURFACE = True
print("[TS-02] USE_GLOBAL_BIHARMONIC_SURFACE=True (diagnostic regeneration)")
module.main()
