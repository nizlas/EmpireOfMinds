# Empire of Minds — TS-08 Stage 1 no-cut thin-plate CG regeneration runner.
# Run: blender --background --python tools/blender/terrain/run_ts08_stage1_no_cut_thin_plate_cg_regen.py
...
_RUNNER_NAME = "run_ts08_stage1_no_cut_thin_plate_cg_regen.py"
_GENERATOR = "generate_ts08_stage1_no_cut_thin_plate_cg.py"
...
spec = importlib.util.spec_from_file_location("eom_ts08_stage1", GENERATOR)
...
print(f"[{module.PROTOTYPE_ID}] dedicated TS-08 Stage 1 no-cut thin-plate CG regeneration")
module.main()
