# Empire of Minds — HXP-03 one-shot HexPatch v1 blend regeneration helper.
# Run: blender --background --python tools/blender/terrain/run_hxp03_v1_blend_regen.py
...
def _resolve_terrain_tools_dir() -> Path:
    ...
    try:
        ...
        for text in bpy.data.texts:
            if text.filepath and Path(text.filepath).name == "run_hxp03_v1_blend_regen.py":
